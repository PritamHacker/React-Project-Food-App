    ...
    <section className='shop_section'>
        <Container>
            <Row className='align-items-centre'>
                ...
                <Col lg={6}>
                    <img src={DownloadImage} className='img-fluid e_shop' alt='Shop' />
                </Col>
            </Row>
        </Container>
    </section>
                        ...
                        <Carousel.Caption>
                            <div className='d-flex align-items-center justify-content-between'>
                                <div className='brand_img'>
                                    <img src={Brand1} className='img-fluid' alt='Brand Image1' />
                                </div>
                                <div className='brand_img'>
                                    <img src={Brand2} className='img-fluid' alt='Brand Image2' />
                                </div>
                                <div className='brand_img'>
                                    <img src={Brand3} className='img-fluid' alt='Brand Image3' />
                                </div>
                                <div className='brand_img'>
                                    <img src={Brand4} className='img-fluid' alt='Brand Image4' />
                                </div>
                                <div className='brand_img'>
                                    <img src={Brand5} className='img-fluid' alt='Brand Image5' />
                                </div>
                                <div className='brand_img'>
                                    <img src={Brand6} className='img-fluid' alt='Brand Image6' />
                                </div>
                            </div>
                        </Carousel.Caption>
                    </Carousel.Item>
                    <Carousel.Item>
                        <Carousel.Caption>
                            <div className='d-flex align-items-center justify-content-between'>
                                ...
                                <div className='brand_img'>
                                    <img src={Brand7} className='img-fluid' alt='Brand Image7' />
                                </div>
                                <div className='brand_img'>
                                    <img src={Brand8} className='img-fluid' alt='Brand Image8' />
                                </div>
                            </div>
                        </Carousel.Caption>
                    </Carousel.Item>
